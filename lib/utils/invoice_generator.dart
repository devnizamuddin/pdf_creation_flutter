...
import 'package:pdf_creation_flutter/models/product.dart';
...
class InvoiceGenerator {
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat) async {
    ...
    _logo = pw.MemoryImage(
      (await rootBundle.load('assets/amazon_logo.png')).buffer.asUint8List(),
    );
    _bgShape = await rootBundle.loadString('assets/invoice_background.svg');
      ...
      children: [
        ...
        pw.Expanded(
          child: pw.Row(
            children: [
              pw.Container(
                margin: const pw.EdgeInsets.only(left: 24, right: 10),
                height: 70,
                child: pw.Text(
                  'Invoice to:',
                  style: pw.TextStyle(
